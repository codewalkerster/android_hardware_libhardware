...
int resample_process(struct resample_para *resample, unsigned int in_frame,
    ...
    if (resample->input_channels == 2 && resample->output_channels == 2) {
        while (inputIndex == 0) {
    ...
    } else if (resample->input_channels == 2 && resample->output_channels == 1) {
        ...
        resample->lastsample_left = input[2 * in_frame - 2];
        resample->SampleFraction = frac;
    }else if (resample->input_channels == 1 && resample->output_channels == 2) {
        while (inputIndex == 0) {
            temp = clip((int) lastsample_left +
                ((((int) input[0] - (int) lastsample_left) * ((int) frac >> 13)) >> 15));
        ...
        while (inputIndex < in_frame) {
            temp = clip((int) input[ inputIndex - 1] + ((((int) input[ inputIndex]
                - (int) input[ inputIndex - 1]) * ((int) frac >> 13)) >> 15));
        ...
        resample->lastsample_left = input[in_frame - 1];
        resample->SampleFraction = frac;
    }else if (resample->input_channels == 1 && resample->output_channels == 1) {
        while (inputIndex == 0) {
            *output++ = clip((int) lastsample_left +
                ((((int) input[0] - (int) lastsample_left) * ((int) frac >> 13)) >> 15));
        ...
        while (inputIndex < in_frame) {
            *output++ = clip((int) input[ inputIndex - 1] + ((((int) input[ inputIndex]
                - (int) input[ inputIndex - 1]) * ((int) frac >> 13)) >> 15));
